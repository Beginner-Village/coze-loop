# @cozeloop/tailwind-config

Tailwind config

## Overview

This package is part of the YNET Loop monorepo and provides development tools functionality. It serves as a core component in the YNET Loop ecosystem.
