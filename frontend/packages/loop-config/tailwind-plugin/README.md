...
A plugin system package for the YNET Loop ecosystem

## Overview

This package is part of the YNET Loop monorepo and provides plugin system functionality. It serves as a core component in the YNET Loop ecosystem.
